declare namespace zreact {
	...
	abstract class Component<PropsType, StateType> {
		...
		public setState<K extends keyof StateType>(state:Pick<StateType, K>, callback?:() => void):void;
		public setState<K extends keyof StateType>(fn:(prevState:StateType, props:PropsType) => Pick<StateType, K>, callback?:() => void):void;
